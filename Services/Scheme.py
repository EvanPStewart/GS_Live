...
# Right here
# Check for folder GS_Live/Schemes
# if GS_Live/Schemes does not exists, make it
# You will use os module
###

# Make all comment-like strings comments
# Fix invalid error checking
# Make hard coded paths dynamic
